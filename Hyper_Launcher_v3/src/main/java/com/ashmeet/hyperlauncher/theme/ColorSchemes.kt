...
fun generateCustomColorScheme(primary: Color, isDark: Boolean): ColorScheme {
    ...
    return if (isDark) {
        darkColorScheme(
            primary = Color.hsv(hue, 0.4f, 0.9f),
            onPrimary = Color.hsv(hue, 0.8f, 0.2f),
            primaryContainer = Color.hsv(hue, 0.6f, 0.35f),
            onPrimaryContainer = Color.hsv(hue, 0.1f, 0.95f),
            inversePrimary = Color.hsv(hue, 0.8f, 0.4f),
            secondary = Color.hsv(hue, 0.3f, 0.8f),
            onSecondary = Color.hsv(hue, 0.8f, 0.2f),
            secondaryContainer = Color.hsv(hue, 0.5f, 0.3f),
            onSecondaryContainer = Color.hsv(hue, 0.1f, 0.9f),
            ...
            background = Color.hsv(hue, 0.1f, 0.08f),
            onBackground = Color.hsv(hue, 0.05f, 0.9f),
            surface = Color.hsv(hue, 0.12f, 0.1f),
            onSurface = Color.hsv(hue, 0.05f, 0.9f),
            surfaceVariant = Color.hsv(hue, 0.15f, 0.2f),
            onSurfaceVariant = Color.hsv(hue, 0.05f, 0.8f),
            surfaceTint = Color.hsv(hue, 0.4f, 0.9f),
            inverseSurface = Color.hsv(hue, 0.05f, 0.9f),
            inverseOnSurface = Color.hsv(hue, 0.1f, 0.1f),
            ...
            outline = Color.hsv(hue, 0.2f, 0.6f),
            outlineVariant = Color.hsv(hue, 0.15f, 0.3f),
            scrim = Color.Black,
            surfaceBright = Color.hsv(hue, 0.1f, 0.2f),
            surfaceDim = Color.hsv(hue, 0.1f, 0.06f),
            surfaceContainer = Color.hsv(hue, 0.1f, 0.12f),
            surfaceContainerHigh = Color.hsv(hue, 0.1f, 0.17f),
            surfaceContainerHighest = Color.hsv(hue, 0.1f, 0.22f),
            surfaceContainerLow = Color.hsv(hue, 0.1f, 0.1f),
            surfaceContainerLowest = Color.hsv(hue, 0.1f, 0.04f),
            primaryFixed = Color.hsv(hue, 0.4f, 0.9f),
            primaryFixedDim = Color.hsv(hue, 0.4f, 0.8f),
            onPrimaryFixed = Color.hsv(hue, 0.8f, 0.1f),
            onPrimaryFixedVariant = Color.hsv(hue, 0.6f, 0.2f),
            secondaryFixed = Color.hsv(hue, 0.3f, 0.8f),
            secondaryFixedDim = Color.hsv(hue, 0.3f, 0.7f),
            onSecondaryFixed = Color.hsv(hue, 0.8f, 0.1f),
            onSecondaryFixedVariant = Color.hsv(hue, 0.6f, 0.2f),
        ...
        lightColorScheme(
            primary = Color.hsv(hue, 0.8f, 0.4f),
            onPrimary = Color.White,
            primaryContainer = Color.hsv(hue, 0.15f, 0.9f),
            onPrimaryContainer = Color.hsv(hue, 0.9f, 0.1f),
            inversePrimary = Color.hsv(hue, 0.4f, 0.9f),
            secondary = Color.hsv(hue, 0.4f, 0.5f),
            onSecondary = Color.White,
            secondaryContainer = Color.hsv(hue, 0.1f, 0.95f),
            onSecondaryContainer = Color.hsv(hue, 0.9f, 0.1f),
            ...
            background = Color.hsv(hue, 0.05f, 0.98f),
            onBackground = Color.hsv(hue, 0.9f, 0.1f),
            surface = Color.hsv(hue, 0.03f, 1.0f),
            onSurface = Color.hsv(hue, 0.9f, 0.1f),
            surfaceVariant = Color.hsv(hue, 0.1f, 0.9f),
            onSurfaceVariant = Color.hsv(hue, 0.7f, 0.3f),
            surfaceTint = Color.hsv(hue, 0.8f, 0.4f),
            inverseSurface = Color.hsv(hue, 0.8f, 0.2f),
            inverseOnSurface = Color.hsv(hue, 0.05f, 0.95f),
            ...
            outline = Color.hsv(hue, 0.4f, 0.5f),
            outlineVariant = Color.hsv(hue, 0.2f, 0.8f),
            scrim = Color.Black,
            surfaceBright = Color.hsv(hue, 0.02f, 0.98f),
            surfaceDim = Color.hsv(hue, 0.1f, 0.87f),
            surfaceContainer = Color.hsv(hue, 0.05f, 0.94f),
            surfaceContainerHigh = Color.hsv(hue, 0.05f, 0.92f),
            surfaceContainerHighest = Color.hsv(hue, 0.05f, 0.89f),
            surfaceContainerLow = Color.hsv(hue, 0.05f, 0.96f),
            surfaceContainerLowest = Color.White,
            primaryFixed = Color.hsv(hue, 0.15f, 0.9f),
            primaryFixedDim = Color.hsv(hue, 0.3f, 0.8f),
            onPrimaryFixed = Color.hsv(hue, 0.9f, 0.1f),
            onPrimaryFixedVariant = Color.hsv(hue, 0.7f, 0.3f),
            secondaryFixed = Color.hsv(hue, 0.1f, 0.95f),
            secondaryFixedDim = Color.hsv(hue, 0.2f, 0.85f),
            onSecondaryFixed = Color.hsv(hue, 0.9f, 0.1f),
            onSecondaryFixedVariant = Color.hsv(hue, 0.7f, 0.3f),
